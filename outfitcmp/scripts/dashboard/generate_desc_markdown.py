...
DESCRIPTION_TEMPLATE_SHORT = os.path.join(WORKING_DIR, 'description_template_short.txt')
...
def generate_short_description_markdown(dashboard_config, experiment_config, experiment_dir):
    """ Generate an experiment's description """
    with open(DESCRIPTION_TEMPLATE_SHORT) as md_file:
        data = md_file.read()
